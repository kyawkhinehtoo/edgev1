...
class billingExport implements FromQuery, WithMapping,WithHeadings,WithColumnFormatting,ShouldAutoSize
{
    use Exportable;
    /**
    ...
    */
    ...
    public function query()
    {
        ...
        ->with(['bill','isp'])
        ->where('bill_id', $this->request->bill_id);
        return $billings;
    ...
    public function columnFormats(): array
    {
        return [
            ...
            'G' => StyleNumberFormat::FORMAT_NUMBER,
            'I' => StyleNumberFormat::FORMAT_NUMBER,
            'H' => StyleNumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1,
            'J' => StyleNumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1,
            ...
            'P' => StyleNumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1,
        ];
    }
    public function map($billing): array
    {
        ...
        return [
            ...
            $billing->bill?->bill_number,// Bill Number
            $billing->invoice_number,// Bill Number
            $billing->bill?->billing_period,// Bill Month
