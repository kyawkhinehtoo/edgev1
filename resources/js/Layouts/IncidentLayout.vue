              ...
              <div class="h-1 mt-0 p-0" style="background: linear-gradient(to right, #CF970BCC 20%, #D65B09FF 80%);"></div>
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <img v-if="$page.props.logo_small" :src="`/storage/${$page.props.logo_small}`"
                                    alt="Logo" class="w-16 select-none" />
                                <label class="p2 ml-2 mt-2 text-lg"><span class="font-bold text-lm-gray">Incident
                                        Panel</span></label>
                            </div>
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link  :href="route('incident.index')" :active="route().current('incident.*')">
                            Ticket
                        </jet-responsive-nav-link >
                        <jet-responsive-nav-link :href="route('mytask.index')" :active="route().current('mytask.*')" v-if="$page.props.login_type != 'isp' "> 
                            My Task
                        </jet-responsive-nav-link>
                    </div>
