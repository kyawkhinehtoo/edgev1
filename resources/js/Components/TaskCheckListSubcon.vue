                      ...
                      <div class="mt-2 flex">
                        <label class="flex-auto items-center">
                          <input type="radio" class="form-radio h-5 w-5 text-blue-600"
                            :name="`checklist_${checklist.id}_status`"
                            v-model="form[`checklist_${checklist.id}_status`]" value="" />
                          <span class="ml-2 text-gray-700 text-sm">N/A</span>
                        </label>
                        <label class="flex-auto items-center">
                          <input type="radio" class="form-radio h-5 w-5 text-yellow-600"
                            :name="`checklist_${checklist.id}_status`"
                            v-model="form[`checklist_${checklist.id}_status`]" value="skip" />
                          <span class="ml-2 text-gray-700 text-sm">Skip</span>
                        </label>
                        <label class="flex-auto items-center">
                          <input type="radio" class="form-radio h-5 w-5 text-yellow-600"
                            :name="`checklist_${checklist.id}_status`"
                            v-model="form[`checklist_${checklist.id}_status`]" value="requested" />
                          <span class="ml-2 text-gray-700 text-sm">Request</span>
                        </label>
                        <label class="flex-auto items-center">
