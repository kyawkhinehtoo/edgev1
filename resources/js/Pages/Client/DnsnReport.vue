                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-auto ">
                        <thead class="bg-gray-50">
                            <tr class="text-left">
                                ...
                                <th scope="col" class="px-4 py-3 text-xs font-medium text-gray-500 uppercase">DN Splitter
                                </th>
                                <th scope="col" class="px-4 py-3 text-xs font-medium text-gray-500 uppercase">SN Splitter
                                </th>
