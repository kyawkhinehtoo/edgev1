                    ...
                    <div class="">
                      <div class="mb-4">
                        ...
                        <input type="text"
                          ...
                          id="name" placeholder="Enter Project Name" v-model="form.name" />
  ...
  setup(props) {
    ...
    function submit() {
      if (!editMode.value) {
        ...
        form._method = "PUT";
        router.post("/project/" + form.id, form, {
          onSuccess: (page) => {
            closeModal();
            resetForm();
            Toast.fire({
    ...
    function deleteRow(data) {
      ...
      data._method = "DELETE";
      router.post("/project/" + data.id, data, {
        preserveState: true,
        onSuccess: (page) => {
          closeModal();
          resetForm();
    ...
    const searchTsp = () => {
      ...
      router.get("/project/", { project: search.value }, { preserveState: true });
    };
