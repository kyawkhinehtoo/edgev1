                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 text-sm">
                            <tr v-for="(row, index) in services.data" v-bind:key="row.id"
                                ...
                                <td class="px-3 py-3 text-left text-md font-medium whitespace-nowrap">{{ row.max_speed
                                }} Mbps
                                </td>
                                <td class="px-3 py-3 text-left text-md font-medium">
                                    <div v-if="isJsonString(row.rate)" class="flex flex-wrap gap-1">
                                        <span v-for="(item, index) in JSON.parse(row.rate)" :key="index" 
                                            ...
                                            <span class="font-semibold">{{ item.min }}</span> &nbsp;Ports: 
                                            ...
                                            <div class="col-span-1 sm:col-span-1">
                                                ...
                                                <div class="py-2">
                                                    <label for="max_speed"
                                                        ...
                                                        Speed</label>
                                                    <div class="mt-1 flex rounded-md shadow-sm">
                                                        <input type="number" v-model="form.max_speed" name="max_speed"
                                                            id="max_speed"
                                                ...
                                                <div class="py-2">
                                                    ...
                                                    <div class="mt-1 flex">
                                                        <label class="flex-auto items-center mt-3">
                                                            <input type="radio"
                                                                class="form-radio h-5 w-5 text-green-600" name="type"
                                                                v-model="form.type" value="FTTH" />
                                                            <span class="ml-2 text-gray-700">FTTH</span>
                                                        </label>

                                                        <label class="flex-auto items-center mt-3">
                                                            <input type="radio"
                                                                class="form-radio h-5 w-5 text-yellow-600" name="type"
                                                                v-model="form.type" value="DIA" />
                                                        ...
                                                        <label class="flex-auto items-center mt-3">
                                                            <input type="radio" class="form-radio h-5 w-5 text-red-600"
                                                                name="type" v-model="form.type" value="IPVPN" />
                                                ...
                                                <label for="rate"
                                                    class="block text-gray-700 text-md font-bold">Installation
                                                    Rate </label>
                                                <div class="mb-4 ">
                                                    <div v-for="(rule, index) in form.rate" :key="index"
                                                        ...
                                                        <label
                                                            class="block text-gray-700 text-sm font-bold">Ports:</label>
                                                        <div class="mt-1 flex rounded-md shadow-sm">
                                                        ...
                                                        <div class="mt-1 flex rounded-md shadow-sm">
                                                            <input type="number" v-model="rule.fees"
                                                                placeholder="e.g., 25000" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300">
                                                            <span
...
export default {
    ...
    setup(props) {
        ...
        const searchService = () => {
            router.get("/port-sharing-service", { service: search.value }, { preserveState: true });
        };
