<template>
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-white leading-tight">Maintenance Services Info</h2>
        </template>
                        ...
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Fees</th>
                                <th scope="col" class="relative px-6 py-3"><span class="sr-only" v-if="$page.props.login_type =='internal'">Action</span></th>
                            </tr>
                        </thead>
