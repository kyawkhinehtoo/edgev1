<template>
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-white leading-tight">City Setup</h2>
    </template>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="(row, index) in cities.data" :key="row.id">
                <td class="px-6 py-4 whitespace-nowrap">{{ cities.from + index }}</td>
                    ...
                    <div class="">
                      ...
                      <div class="mb-4">
                        ...
                        <input type="text"
                          ...
                          id="city" placeholder="Enter city" v-model="form.name">
        ...
        <Pagination :links="cities.links" class="mt-6" v-if="cities.links" />
      </div>
    </div>
  </app-layout>
</template>
...
export default {
  ...
  setup(props) {
    ...
    const searchTsp = () => {
      ...
      router.get('/city/', { city: search.value }, { preserveState: true })
    }
