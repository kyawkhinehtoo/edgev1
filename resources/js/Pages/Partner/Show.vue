<template>
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-white leading-tight">Partner Details</h2>
    </template>

    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="mb-4">
          <Link :href="route('partner.index')" class="inline-flex items-center px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          ...
          <div class="p-6">
            ...
            <div class="mb-8">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div v-if="partner.logo" class="mb-4">
                  <img :src="'/storage/' + partner.logo" :alt="partner.name + ' Logo'" class="h-32 w-auto">
                </div>  
                ...
                <div>
                  ...
                  <p class="mt-1">{{ partner.name }}</p>
                </div>
                <div>
                  <p class="text-sm font-medium text-gray-500">Contact Person</p>
                  <p class="mt-1">{{ partner.contact_person }}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p class="mt-1">{{ partner.email }}</p>
                </div>
                <div class="col-span-2">
                  <p class="text-sm font-medium text-gray-500">Address</p>
                  <p class="mt-1">{{ partner.address }}</p>
                </div>
                <div>
            ...
            <div class="mt-8">
              <h3 class="text-lg font-medium text-gray-900 mb-4">Partner Users</h3>
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  <tr v-if="partner.users.length === 0">
                    <td colspan="5" class="px-6 py-4 text-center text-gray-500">No users found for this partner</td>
                  </tr>
                </tbody>
              </table>
            </div>
