<template>
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-white leading-tight">Create ISP</h2>
    </template>
            ...
            <div v-if="activeTab === 'data'">
              <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div v-if="form.errors.short_code" class="text-red-500 text-xs mt-1">{{ form.errors.short_code }}</div>
                </div>
                <div>
